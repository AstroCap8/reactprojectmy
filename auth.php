        ...
        <div class="container main">
            <div class="row">
                <div class="col-lg-12 mt-5 text-center">
                    <h1 class="whitetext">Авторизация</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-3"></div>
                <div class="col-lg-6 p-4">
                    <form class="" action="vendor/signin.php" method="post" enctype="multipart/form-data">
                        <div class="col-lg-12">
                            <label class="fs-4 ms-3 mb-3 mt-4 whitetext">Логин</label>
                        </div>
                        <div class="col-lg-12">
                            <input class="fs-5 ms-3 fs-4 whitetext" name="login" type="text" placeholder="Введите логин" id="">
                        </div>
                        <div class="col-lg-12">
                            <label class="fs-4 ms-3 mb-3 mt-4 whitetext">Пароль</label>
                        </div>
                        <div class="col-lg-12">
                            <input class="fs-5 ms-3 fs-4 whitetext" name="password" type="password" placeholder="Введите пароль" id="">
                        </div>
                        <div class="col-lg-12 text-center fs-5 mt-4 mb-2">
                            <button class="fs-4" type="submit">Войти</button>
                            ...
                            <p class="mt-3 whitetext">Нет аккаунта? - <a href="register.php"> Зарегистрироваться </a></p>
                        </div>
                    </form>
                </div>
                <div class="col-lg-3"></div>
